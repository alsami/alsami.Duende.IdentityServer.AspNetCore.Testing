...
For more samples and usages, please also have a look at the [tests](https://github.com/alsami/alsami.Duende.IdentityServer.AspNetCore.Testing/tree/master/test).