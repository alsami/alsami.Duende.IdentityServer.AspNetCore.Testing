# [5.0.0](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/5.0.0) (2021-12-03)
...
* Update Duende.IdentityServer to version `4.1.2`
...
# [4.2.0](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/4.2.0) (2021-11-04)

## Features

Allow `ApiResource` and `ApiScope` to differ and only check that an `ApiResource` has corresponding `ApiScope`. Thanks to [@gerrylowe](https://github.com/gerrylowe)! Closes [#5](https://github.com/alsami/Duende.IdentityServer.Contrib.AspNetCore.Testing/issues/5)

# [4.0.0](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/4.0.0) (2020-06-20)

## Features

* Support for `Duende.IdentityServer` version 4

# [4.0.0-rc.3](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/4.0.0-rc.3) (2020-06-13)

## Features

* Support for `Duende.IdentityServer` version 4 preview 6

# [4.0.0-rc.2](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/4.0.0-rc.1) (2020-05-22)
...
# [4.0.0-rc.1](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/4.0.0-rc.1) (2020-05-21)

## Features

* Support for `Duende.IdentityServer` version 4 preview 5
...
# [4.0.0-rc.0](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/4.0.0-rc.0) (2020-05-10)

## Features

* Support for `Duende.IdentityServer` version 4 preview 3
...
* When defining an `ApiResource` according `ApiScope` is required to be passed along. This is a breaking-change introduced through the update of `Duende.IdentityServer` to version 4. The according builder used validates that api-scopes are present when using api-resources. It will throw an exception if not.
* For more details on the breaking changes of `Duende.IdentityServer` please check out the [changelog](https://github.com/IdentityServer/Duende.IdentityServer/releases/tag/4.0.0-preview.4) ot it.
...
# [3.1.1](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/3.1.1) (2019-12-26)

## Chore

* Update `Duende.IdentityServer` to version `3.1.0`

# [3.1.0](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/3.1.0) (2019-12-11)
...
# [3.0.2](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/3.0.2) (2019-11-12)

## Chore

* Update `Duende.IdentityServer` to 3.0.2
* Update `IdentityModel` to 4.1.0

# [3.0.1](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/3.0.1) (2019-09-25)

## Chore

* Update `Duende.IdentityServer` to 3.0.1

# [3.0.0](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/3.0.0) (2019-09-23)
...
# [1.4.0](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/1.4.0) (2019-07-19)

## Chore

* Update `Duende.IdentityServer` to version 2.5.0
* Update `IdentitxModel` to version 3.10.10

# [1.3.0](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/1.3.0) (2019-05-05)

## Features

* Add constructor to `IdentityServerProxy` to directly pass in a `TestServer`

# [1.2.0](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/1.2.0) (2019-04-09)
...
# [1.1.0](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/1.1.0) (2019-04-08)

## Features

* Expose `TestServer` from class `IdentityServerProxy` in order to be able to create a handler manually.

# [1.0.0](https://www.nuget.org/packages/Duende.IdentityServer.Contrib.AspNetCore.Testing/1.0.0) (2019-04-08)
...
### [IdentityServerWebHostBuilder](https://github.com/alsami/Duende.IdentityServer.Contrib.AspNetCore.Testing/blob/master/src/Duende.IdentityServer.Contrib.AspNetCore.Testing/Builder/IdentityServerWebHostBuilder.cs)
...
### [IdentityServerProxy](https://github.com/alsami/Duende.IdentityServer.Contrib.AspNetCore.Testing/blob/master/src/Duende.IdentityServer.Contrib.AspNetCore.Testing/Services/IdentityServerProxy.cs)

The `IndentityServerProxy`, as the name says, serves as a proxy for `Duende.IdentityServer` and takes a `WebHostBuilder` as constructor parameter, then creates a `TestServer` from `Microsoft.AspNetCore.Mvc.Testing`
